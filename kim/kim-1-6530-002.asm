...
;
	SBD 	= $1740	; B data register
	SAD 	= $1741	; A data register
	PBDD    = $1742	; B data direction register
	PADD    = $1743	; A data direction register
...
LIGHTS  LDX #$09 ; Digit number: $09, $0B, $0D, $0F, $11, $13
LIGHTD	TXA
        STA SBD
